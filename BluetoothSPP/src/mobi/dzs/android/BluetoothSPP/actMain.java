...
public class actMain extends BaseActivity
{
	...
	private class SPPClient extends AsyncTask
	{
		...
		protected  Integer doInBackground(String as[])//transient
		{
		...
		protected Object doInBackground(Object aobj[])//volatile transient
		{
			return doInBackground((String[])aobj);
		}

		public void onPostExecute(Integer integer)//onPostExecute方法是在doInBackground方法执行之后执行
		{
