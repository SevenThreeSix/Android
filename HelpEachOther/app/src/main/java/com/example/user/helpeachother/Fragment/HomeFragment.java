...
import com.example.user.helpeachother.dummy.DummyContentLatestChatList;
...
public class HomeFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public static final String folderPath = "/storage/emulated/0/helpeachother/";
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    mc.dout.writeUTF("<#LATEST_CHAT_LIST#>" + uno + "|" + "1"); // 向服务器发出请求
                    ...
                    DC = new DummyContentLatestChatList();
                    DC.clearItem();
                    ...
                    for (int i = 0; i < listsize; i++) { // 循环，获取每个好友的信息和头像
                        ...
                        if(sa[1].equals(uno))
                            DC.addItem(DummyContentLatestChatList.createDummyItem(i,sa[1],sa[2],sa[3],sa[2],time));
                        else
                            DC.addItem(DummyContentLatestChatList.createDummyItem(i,sa[1],sa[2],sa[3],sa[1],time));
                        //DC.addItem(DummyContentLatestChatList.createDummyItem(i,sa[7],sa[1]));
                        // 将好友信息添加到相应的列表中
...
//					pd.dismiss();
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        recyclerView.setAdapter(new HomeFragment.SimpleItemRecyclerViewAdapter(DummyContentLatestChatList.ITEMS, mTwoPane));
    }
    ...
    public class SimpleItemRecyclerViewAdapter
        ...
        private final List<DummyContentLatestChatList.DummyItem> mValues;
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DummyContentLatestChatList.DummyItem item = (DummyContentLatestChatList.DummyItem) view.getTag();
                /*if (mTwoPane) {
                ...
                intent.putExtra("ubno", item.realbno);
        ...
        SimpleItemRecyclerViewAdapter(
                List<DummyContentLatestChatList.DummyItem> items,
                boolean twoPane) {
            mValues = items;
        ...
        public void onBindViewHolder(final HomeFragment.SimpleItemRecyclerViewAdapter.ViewHolder holder, int position) {
            ...
            //while(builder.toString().length()<42)
              //  builder.append(" ");
            ...
            holder.mTime.setEllipsize(TextUtils.TruncateAt.MARQUEE);
            holder.mTime.setSingleLine(true);
            holder.mTime.setSelected(true);
            holder.mTime.setFocusable(true);
            holder.mTime.setFocusableInTouchMode(true);

            holder.itemView.setTag(mValues.get(position));
            holder.itemView.setOnClickListener(mOnClickListener);


            holder.item_uno.setText(mValues.get(position).realbno);

            updateHolderImage(holder,mValues.get(position).realbno);
        }
        public void updateHolderImage(final HomeFragment.SimpleItemRecyclerViewAdapter.ViewHolder holder,String uno){
