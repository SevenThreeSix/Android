...
public class DashboardFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_dashboardragment, container, false);
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    mc.dout.writeUTF("<#DATE_LIST#>" + uno + "|" + "1|0"); // 向服务器发出请求
                    ...
                    for (int i = 0; i < listsize; i++) { // 循环，获取每个好友的信息和头像
                        ...
                        DC.addItem(DummyContent.createDummyItem(i,sa[0],sa[7],sa[1],sa[3],sa[4],sa[8],sa[9]));
...
//					pd.dismiss();
    ...
    public class SimpleItemRecyclerViewAdapter
       ...
       /* private final View.OnClickListener ImageOnClickListener = new View.OnClickListener() {
        ...
        public void updateHolderImage(final DashboardFragment.SimpleItemRecyclerViewAdapter.ViewHolder holder,String uno){
