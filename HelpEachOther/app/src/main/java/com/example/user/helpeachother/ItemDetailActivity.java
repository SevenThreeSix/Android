...
public class ItemDetailActivity extends AppCompatActivity {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(mUno.equals(mItem.uno))
                    ...
                    Intent intent = new Intent(ItemDetailActivity.this, ChatActivity.class);    //创建Intent对象
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_show_map) {
            Intent intent = new Intent(ItemDetailActivity.this, MapActivity.class);    //创建Intent对象
            //intent.putExtra("ubno", mItem.content.substring(0, 4));
            //intent.putExtra(ItemDetailFragment.ARG_ITEM_ID, itemID);
            intent.putExtra(ItemDetailFragment.ARG_ITEM_ID, itemID);
            intent.putExtra("from", "ItemDetailActivity");
            startActivity(intent);
            return true;
        }
            ...
            builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    if(mUno.equals(mItem.uno))
                        ...
                        Snackbar.make(CL, "接受成功 !", Snackbar.LENGTH_LONG)
                                .setAction("Action", null).show();
                    }
    ...
    Handler myHandlerRecieve = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    Toast.makeText(ItemDetailActivity.this, "接收任务成功", Toast.LENGTH_SHORT).show();

                    break;
                case 1:
                    Toast.makeText(ItemDetailActivity.this, "接收任务失败", Toast.LENGTH_SHORT).show();
                    break;
                case 2:
                    Toast.makeText(ItemDetailActivity.this, "连接超时", Toast.LENGTH_SHORT).show();
