...
public class LeDeviceListAdapter extends BaseAdapter {
	...
	public View getView(int i, View view, ViewGroup viewGroup) {
		...
		if (view == null) {
			view = mInflator.inflate(R.layout.item_list_device_content, null);
		...
		if (i % 2 == 0)// set color
		{
			view.setBackgroundColor(Color.argb(255, 5, 98, 94));//Color.argb(255, 255, 0, 0));0xff119999
		} else {
			view.setBackgroundColor(Color.argb(255, 5, 98, 94));//Color.argb(25, 0, 255, 0));Color.BLACK//Color.argb(255, 57, 226, 199)
		}
		return view;
	}
