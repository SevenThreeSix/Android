...
public class MainActivity extends Activity
{
	...
	private OnClickListener button2ClickListener = new OnClickListener() {
		public void onClick(View arg0) {    	
				    	mPrintWriterClient.print("2");
				    	mPrintWriterClient.flush();
		}
	};
	private OnClickListener button3ClickListener = new OnClickListener() {
		public void onClick(View arg0) {	    	
	...
	private OnClickListener button7ClickListener = new OnClickListener() {
		public void onClick(View arg0) {	    	
				    	mPrintWriterClient.print("7");
				    	mPrintWriterClient.flush();
		}
	};
	private OnClickListener button8ClickListener = new OnClickListener() {
		public void onClick(View arg0) {   	
