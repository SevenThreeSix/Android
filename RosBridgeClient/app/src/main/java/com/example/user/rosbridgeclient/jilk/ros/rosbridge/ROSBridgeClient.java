 ...
 * 
 */
package com.example.user.rosbridgeclient.jilk.ros.rosbridge;

import com.example.user.rosbridgeclient.jilk.ros.ROSClient;
import com.example.user.rosbridgeclient.jilk.ros.Service;
import com.example.user.rosbridgeclient.jilk.ros.message.Message;
import com.example.user.rosbridgeclient.jilk.ros.message.MessageType;
import com.example.user.rosbridgeclient.jilk.ros.rosapi.message.Empty;
import com.example.user.rosbridgeclient.jilk.ros.rosapi.message.MessageDetails;
import com.example.user.rosbridgeclient.jilk.ros.rosapi.message.Nodes;
import com.example.user.rosbridgeclient.jilk.ros.rosapi.message.Services;
import com.example.user.rosbridgeclient.jilk.ros.rosapi.message.Topic;
import com.example.user.rosbridgeclient.jilk.ros.rosapi.message.Topics;
import com.example.user.rosbridgeclient.jilk.ros.rosapi.message.Type;
import com.example.user.rosbridgeclient.jilk.ros.rosapi.message.TypeDef;
import com.example.user.rosbridgeclient.jilk.ros.rosbridge.implementation.ROSBridgeWebSocketClient;
import com.example.user.rosbridgeclient.jilk.ros.rosbridge.operation.Operation;
...
public class ROSBridgeClient extends ROSClient {
    ...
    private String getServiceType(String service) throws InterruptedException {
        Service<com.example.user.rosbridgeclient.jilk.ros.rosapi.message.Service, Type> serviceTypeService =
                new Service<com.example.user.rosbridgeclient.jilk.ros.rosapi.message.Service, Type>("/rosapi/service_type",
                        com.example.user.rosbridgeclient.jilk.ros.rosapi.message.Service.class, Type.class, this);
        return serviceTypeService.callBlocking(new com.example.user.rosbridgeclient.jilk.ros.rosapi.message.Service(service)).type;
    }
