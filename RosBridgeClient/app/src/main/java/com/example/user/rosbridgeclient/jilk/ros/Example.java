 ...
 * 
 */
package com.example.user.rosbridgeclient.jilk.ros;

import com.example.user.rosbridgeclient.jilk.ros.message.Clock;
import com.example.user.rosbridgeclient.jilk.ros.message.Log;
import com.example.user.rosbridgeclient.jilk.ros.rosapi.message.Empty;
import com.example.user.rosbridgeclient.jilk.ros.rosapi.message.GetTime;
...
public class Example {
        ...
        try {
            ...
            Service<com.example.user.rosbridgeclient.jilk.ros.rosapi.message.Service, Type> serviceTypeService =
                    new Service<com.example.user.rosbridgeclient.jilk.ros.rosapi.message.Service, Type>("/rosapi/service_type",
                            com.example.user.rosbridgeclient.jilk.ros.rosapi.message.Service.class, Type.class, client);
            serviceTypeService.verify();
            String type = serviceTypeService.callBlocking(new com.example.user.rosbridgeclient.jilk.ros.rosapi.message.Service("/rosapi/service_response_details")).type;
            ...
            com.example.user.rosbridgeclient.jilk.ros.Topic<Log> logTopic =
                    new com.example.user.rosbridgeclient.jilk.ros.Topic<Log>("/rosout", Log.class, client);
            logTopic.verify();
    ...
    public static void testTopic(ROSBridgeClient client) {
        com.example.user.rosbridgeclient.jilk.ros.Topic<Clock> clockTopic = new com.example.user.rosbridgeclient.jilk.ros.Topic<Clock>("/clock", Clock.class, client);
